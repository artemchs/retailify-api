...
describe('CollectionsService', () => {
  ...
  describe('create', () => {
    ...
    it('should create with products', async () => {
      ...
      await service.create({
        ...data,
        products: [{ id: 'Test Product 1' }, { id: 'Test Product 2' }],
      })
      ...
      expect(collectionsCount).toBe(1)
      expect(collection?._count.products).toBe(2)
    })
  ...
  describe('update', () => {
    ...
    it('should connect to products', async () => {
      await db.product.createMany({
        data: [
          {
            id: 'Test Product 1',
    ...
    it('should disconnect from a product', async () => {
